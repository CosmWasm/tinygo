//go:build tinygo.wasm && wasi && !cosmwasm
// +build tinygo.wasm,wasi,!cosmwasm

// NOTE(cosmwasm): modifications:
//   * fd_write export and putchar func added (moved from runtime_tinygowasm.go);
