...
// NOTE(cosmwasm): this is a copy of interface.go with the following modifications:
//   * Float32 and Complex64 reflectValueEqual() cases removed:
//     - they generate false positive float operations;
